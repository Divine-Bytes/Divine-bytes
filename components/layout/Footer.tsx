        ...
        <div className="grid grid-cols-2 md:grid-cols-3 gap-8 md:gap-8">
          ...
          <div className="col-span-2 md:col-span-1 flex flex-col gap-3">
            <div className="flex items-center gap-3">
              <div className="relative w-10 h-10 md:w-12 md:h-12 rounded-full overflow-hidden border-2 border-luxury-gold/50 shrink-0">
                <Image src="/logo.jpeg" alt="Divine Bytes" fill className="object-cover object-center scale-110" sizes="48px" />
              </div>
              <span className="font-heading text-xl md:text-2xl text-luxury-gold">Divine Bytes</span>
            </div>
          ...
          <nav aria-label="Footer navigation">
            <p className="font-body font-medium text-xs text-white/50 uppercase tracking-wider mb-3">Explore</p>
          ...
          <div className="flex flex-col gap-2">
            <p className="font-body font-medium text-xs text-white/50 uppercase tracking-wider mb-1">Get in Touch</p>
